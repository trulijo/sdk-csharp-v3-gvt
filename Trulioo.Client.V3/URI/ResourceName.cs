...
namespace Trulioo.Client.V3.URI
{
    ...
    internal class ResourceName : ReadOnlyCollection<string>, IComparable, IComparable<ResourceName>, IEquatable<ResourceName>
    {
        ...
        /// </exception>
        /// <param name="parts">
        /// The parts that will make up this resource name
        /// </param>
        public ResourceName(IEnumerable<string> parts) : this(parts.ToArray())
        {
        }
        ...
        /// </param>
        /// <param name="parts">
        /// Names to be appended to <paramref name="resourceName"/>.
        /// </param>
        public ResourceName(ResourceName resourceName, params string[] parts) : this(resourceName.Concat(parts).ToArray())
        {
        }
        ...
        /// The parts that will make up this resource name
        /// </param>
        public ResourceName(params string[] parts) : base(parts)
        {
